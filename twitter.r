...
# al3x.twitter.search.geo('#skype', city.latlong[1,]$lat, city.latlong[1,]$long, city.latlong[1,]$radius, 1000)
al3x.twitter.search.geo = function(search, lat, long, radius, num) {
  require(plyr)
  library(twitteR)
  iter = 0
  delta.text = NULL
